...
namespace Workflow.Engine.Services
{
    ...
    {
        private void RemoveEntityAttribute(ProcessInstance process, WorkflowRuntime runtime, string parameters, JObject entity)
        {
            ...
            {
                apiRequestDtoInput.UrlAddress = apiRequestDtoInput.UrlAddress + EngineConstants.RemoveEntityAttributeEndpoint;

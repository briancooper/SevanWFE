...
namespace Workflow.Engine.Services
{
    ...
    {
        private void UpdateUserRoles(ProcessInstance process, WorkflowRuntime runtime, string parameters, JObject entity)
        {
            ...
            {
                apiRequestDtoInput.UrlAddress = apiRequestDtoInput.UrlAddress + EngineConstants.SetUserRolesEndpoint;
